...
export const projectsData = [
  ...
  },
  {
    ...
    type:'full stack',
    img: trackpenseImage,
    description: "All-in-one financial companion, offers powerful tools for Income Management, Expense Tracking, Savings, and Detailed Reports.",
  ...
  },
  {
    ...
    type:'full stack',
    img: doclyImage,
    description: "Streamline the management of patient information in a healthcare facility. Offers tools like patient records, view ward-specific data, etc.",
