  ...
  return (
    <div className="flex flex-col ">
      ...
      <input
        ...
        className=" bg-[var(--secondary-bg-color)] border text-white py-1 px-2 rounded-md"
      />
    </div>
  );
};
    ...
    <>
      <div className="w-full">
        <form className="border shadow-md py-2 px-4 border-[#3f3f4666] rounded-lg">
          ...
          <div className="flex flex-col ">
            <label className="py-1 text-lg text-white font-medium">
              Message
            </label>
            <textarea
              className="bg-[var(--secondary-bg-color)] border text-white py-1 px-2 rounded-md"
          ...
          <div className="py-3 flex my-1 items-center flex-row justify-end ">
            <button
              className="px-3 w-full rounded-md py-1 font-medium text-lg bg-white text-gray-900"
              type="submit"
            >
              Submit
            </button>
